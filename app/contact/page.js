...
const ContactPage = () => {
  ...
  return (
    <section className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      ...
      <p className="mb-8 lg:mb-16 font-light text-center text-gray-900 dark:text-gray-300 sm:text-xl">
      ...
      >
        ...
        <div>
          <Label
            ...
            className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"
          />
          <FileInput name="file" id="file-upload-helper-text" multiple={true} />
        </div>
