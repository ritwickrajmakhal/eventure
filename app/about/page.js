...
const AboutPage = () => {
  ...
  return (
    <>
      ...
      <section>
        <div className='before:content-[""] before:absolute before:top-[0] before:w-full before:h-screen before:bg-[rgba(0,0,0,0.6)] bg-[url("../public/hero.jpg")] bg-cover w-full h-screen fixed top-0 -z-50'></div>
      </section>
      <section
        data-aos="fade-in"
      ...
      >
        ...
        <div className="lg:w-[25vw] md:w-[80vw] w-[80vw] h-fit text-white text-center">
          Welcome to Eventure, Your Personal Event Organiser, where we bring
          your events to life. Our passion is creating unforgettable experiences
          that leave a lasting impression. Whether it&apos;s a corporate
          gathering, a milestone celebration, or a grand opening, we are here to
